...
// Peripheral clock enables set for the selected peripherals.   
   SysCtrlRegs.PCLKCR.bit.EVAENCLK=0; //zmiana z 1 na 0
   SysCtrlRegs.PCLKCR.bit.EVBENCLK=0; //zmiana z 1 na 0
   SysCtrlRegs.PCLKCR.bit.SCIAENCLK=0; //zmiana z 1 na 0
   SysCtrlRegs.PCLKCR.bit.SCIBENCLK=0; //zmiana z 1 na 0
   SysCtrlRegs.PCLKCR.bit.MCBSPENCLK=0; //zmiana z 1 na 0
   SysCtrlRegs.PCLKCR.bit.SPIENCLK=0; //zmiana z 1 na 0
   SysCtrlRegs.PCLKCR.bit.ECANENCLK=1;
   SysCtrlRegs.PCLKCR.bit.ADCENCLK=0; //zmiana z 1 na 0
   EDIS;
}
