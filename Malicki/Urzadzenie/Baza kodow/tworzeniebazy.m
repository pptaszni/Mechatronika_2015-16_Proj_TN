%skrypt do tworzenia bazy danych kodów b³yskowych
...
IDs = [ID1 ID2 ID3 ID4];                %tablica z uchwytami plików
str = fread(IDkom,2*rozmiar_klastra_SD-1);                %wczytanie komentarza max 1024 znaki
n = numel(str);                         %sprawdzenie d³ugoœci komentarza i uzupe³nienie do 1024 znaki
